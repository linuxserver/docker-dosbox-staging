pipeline {
  ...
  environment {
    ...
    EXT_USER = 'dosbox-staging'
    EXT_REPO = 'dosbox-staging'
    BUILD_VERSION_ARG = 'DSTAGING_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-dosbox-staging'
    CONTAINER_NAME = 'dosbox-staging'
    DOCKERHUB_IMAGE = 'linuxserver/dosbox-staging'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/dosbox-staging'
    PR_DOCKERHUB_IMAGE = 'lspipepr/dosbox-staging'
    DIST_IMAGE = 'debian'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-dosbox-staging/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-dosbox-staging\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-dosbox-staging\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Dosbox-staging\" \
          --label \"org.opencontainers.image.description=[DOSBox Staging](https://www.dosbox-staging.org/) is a modern continuation of DOSBox a free and open-source emulator that enables the execution of MS-DOS software, especially video games.\" \
